...
<body>
	...
	<div id = "section">
		...
		<form action = "/sp002/join.jsp">
			<!-- 
				laber tag는 input tag와 한 그룹으로 만들어서
				input tag를 선택하는데 조금 편한 기능을 부여한다.
				laber tag for 속성은 어떤 input tag를 감쌀 것인지
				나타내는 값이다.
			...
			<!--  label에 for 속성을 사용하지 않고
				  laber tag로 input tag를 감싸는 구조로 만들어야 된다.
				  이떄는 tag를 tag가 감싸고 있는 형태가 되어
			...
			<!-- 
				...
				type = "tel" : 모바일에서 전화번호를 쉽게 입력할 수 있도록
				키보드가 나타 난다.
			...
			<!-- 
				button tag에 type이 있는데
				기본값은 type="submit"이며
				이것은 클릭 했을때 form에 포함된 입력 값들을
