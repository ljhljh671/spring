...
<meta name="Keywords"
	content="HTML,CSS,JavaScript,DOM,jQuery,PHP,SQL,XML,Python,Bootstrap,Web,W3CSS,W3C,tutorials,programming,development,training,learning,quiz,primer,lessons,reference,examples,source code,colors,demos,tips,w3c">
...
@media screen and (max-width:768px) {
	.w3-sidebar.w3-collapse, .barex, .navex {
		display: none !important;
	}
...
<body style="position: relative; min-height: 100%;">
	...
	<div class="w3-row w3-white w3-padding w3-hide-medium w3-hide-small"
		...
		<div class="w3-half notranslate" style="margin: 4px 0 6px 0">
			<a class='w3schools-logo' href='//www.w3schools.com'>w3schools<span
				class='dotcom'>.com</span></a>
		</div>
		<div
			class="w3-half w3-margin-top w3-wide w3-hide-medium w3-hide-small">
			<div class="w3-right" style="position: relative; top: 5px;">THE
				WORLD'S LARGEST WEB DEVELOPER SITE</div>
		</div>
	</div>
	...
	<div class="w3-hide-large w3-hide-large w3-padding-16">
		...
		<div class="w3-center w3-wide w3-hide-small"
			style="margin: 14px 0 -5px 0">THE WORLD'S LARGEST WEB DEVELOPER
			SITE</div>
	</div>

	<div
		style='display: none; position: absolute; z-index: 6; right: 60px; height: 57px; padding-top: 12px; padding-right: 20px; background-color: #4CAF50;'
		id='googleSearch'>
		<div class='gcse-search'></div>
	</div>
	<div
		style='display: none; position: absolute; z-index: 5; right: 120px; height: 57px; background-color: #4CAF50; text-align: right; padding-top: 15px;'
		id='google_translate_element'></div>

	<div class="w3-bar w3-theme w3-card-2 w3-wide notranslate">
		<a class="w3-bar-item w3-button w3-hover-white w3-padding-16 hidesm"
			href="javascript:void(0)" onclick="w3_open()"><i class='fa'>&#xf0c9;</i></a>
		<a class="w3-bar-item w3-button barex w3-hover-white w3-padding-16"
			href="javascript:void(0)" onclick="w3_open_nav('tutorials')"
			id="navbtn_tutorials">TUTORIALS <i class='fa fa-caret-down'></i><i
			class='fa fa-caret-up' style="display: none"></i></a> <a
			class="w3-bar-item w3-button barex w3-hover-white w3-padding-16"
			href="javascript:void(0)" onclick="w3_open_nav('references')"
			id="navbtn_references">REFERENCES <i class='fa fa-caret-down'></i><i
			class='fa fa-caret-up' style="display: none"></i></a> <a
			class="w3-bar-item w3-button barex w3-hover-white w3-padding-16"
			href="javascript:void(0)" onclick="w3_open_nav('examples')"
			id="navbtn_examples">EXAMPLES <i class='fa fa-caret-down'></i><i
			class='fa fa-caret-up' style="display: none"></i></a> <a
			class="w3-bar-item w3-button barex w3-hover-white w3-padding-16 w3-hide-medium w3-hide-small w3-hide"
			href="javascript:void(0)" onclick="w3_open_nav('exercises')"
			id="navbtn_exercises">EXERCISES <i class='fa fa-caret-down'></i><i
			class='fa fa-caret-up' style="display: none"></i></a>
		<div class="w3-right">
			<a
				class="w3-bar-item w3-button w3-hover-white w3-padding-16 w3-right"
				href="javascript:void(0)" onclick="open_search(this)"
				title='Search W3Schools'><i class='fa'>&#xe802;</i></a> <a
				class="w3-bar-item w3-button w3-hover-white w3-padding-16 w3-right"
				href="javascript:void(0)" onclick="open_translate(this)"
				title='Translate W3Schools'><i class='fa'>&#xe801;</i></a>
		</div>
	</div>
	...
	<nav class="w3-sidebar w3-collapse w3-white w3-card-2" id="mySidenav">
		<div class="w3-bar-block">
			...
			<a class="w3-bar-item w3-button" href="/html/default.asp">Learn
				...
				W3.CSS</a> <a class="w3-bar-item w3-button" href="/colors/default.asp">Learn
				Colors</a> <a class="w3-bar-item w3-button"
				href="/bootstrap/default.asp">Learn Bootstrap 3</a> <a
				class="w3-bar-item w3-button" href="/bootstrap4/default.asp">Learn
				Bootstrap 4</a> <a class="w3-bar-item w3-button"
				href="/icons/default.asp">Learn Icons</a> <a
				class="w3-bar-item w3-button" href="/graphics/default.asp">Learn
				Graphics</a> <a class="w3-bar-item w3-button" href="/howto/default.asp">Learn
				How To</a>
			<div class="w3-container">
			...
			<a class="w3-bar-item w3-button" href="/xml/default.asp">Learn
				...
				XML AJAX</a> <a class="w3-bar-item w3-button" href="/xml/dom_intro.asp">Learn
				XML DOM</a> <a class="w3-bar-item w3-button"
				href='/xml/xml_dtd_intro.asp'>Learn XML DTD</a> <a
				class="w3-bar-item w3-button" href='/xml/schema_intro.asp'>Learn
				XML Schema</a> <a class="w3-bar-item w3-button"
				href="/xml/xsl_intro.asp">Learn XSLT</a> <a
				class="w3-bar-item w3-button" href='/xml/xpath_intro.asp'>Learn
				XPath</a> <a class="w3-bar-item w3-button" href='/xml/xquery_intro.asp'>Learn
				XQuery</a>
			<div class="w3-container">
			...
			<a class="w3-bar-item w3-button" href='/tags/default.asp'>HTML
				...
				href='/cssref/default.asp'>CSS Reference</a> <a
				class="w3-bar-item w3-button" href='/jsref/default.asp'>JS
				Reference</a> <a class="w3-bar-item w3-button"
				href='/sql/sql_ref_keywords.asp'>SQL Reference</a> <a
				class="w3-bar-item w3-button" href='/php/php_ref_overview.asp'>PHP
				Reference</a> <a class="w3-bar-item w3-button"
				...
				class="w3-bar-item w3-button" href='/charsets/default.asp'>UTF-8
				Reference</a>
			<div class="w3-container">
				<h4 class="w3-margin-top">Exercises</h4>
			</div>
			<a class="w3-bar-item w3-button" href='/html/html_exercises.asp'>HTML
				...
				Exercises</a> <a class="w3-bar-item w3-button"
				href='/sql/sql_exercises.asp'>SQL Exercises</a> <a
				class="w3-bar-item w3-button" href='/php/php_exercises.asp'>PHP
				Exercises</a> <a class="w3-bar-item w3-button"
	...
	<div id='myAccordion'
		class="w3-card-2 w3-light-grey w3-center w3-hide-large"
		style="display: none; cursor: default">
		<a href="javascript:void(0)" onclick="w3_close()"
			class="w3-button w3-xlarge w3-right">&times;</a><br>
		<div class="w3-container w3-padding-32">
			<a class="w3-button w3-block w3-large w3-wide"
			...
			<a class="w3-button w3-block w3-large w3-wide"
				onclick="open_xs_menu('examples')" href="javascript:void(0);">EXAMPLES
				<i class='fa fa-caret-down'></i>
			</a>
			<div id="sectionxs_examples" class="w3-white w3-show"></div>
			<a class="w3-button w3-block w3-large w3-wide w3-hide"
				onclick="open_xs_menu('exercises')" href="javascript:void(0);">EXERCISES
				<i class='fa fa-caret-down'></i>
			</a>
	...
	<nav id="nav_tutorials"
		class="w3-light-grey w3-card-2 w3-hide-small navex">
		<span onclick="w3_close_nav('tutorials')"
			class="w3-button w3-xlarge w3-display-topright barex">&times;</span><br>
		<div class="w3-row-padding w3-bar-block">
			<div class="w3-col l3 m6">
				...
				<a class="w3-bar-item w3-button" href="/html/default.asp">Learn
					...
					href='/graphics/svg_intro.asp'>Learn SVG</a> <a
					class="w3-bar-item w3-button" href='/graphics/canvas_intro.asp'>Learn
					Canvas</a> <a class="w3-bar-item w3-button" href="/howto/default.asp">Learn
					How To</a>
		...
		<div class="w3-row-padding w3-bar-block">
			...
			<div class="w3-col l3 m6">
				...
				<a class="w3-bar-item w3-button" href='/jsref/default.asp'>JavaScript
					...
					href='/jquery/jquery_ref_overview.asp'>jQuery Reference</a> <a
					class="w3-bar-item w3-button"
					href='/angular/angular_ref_directives.asp'>AngularJS Reference</a>
				<a class="w3-bar-item w3-button" href="/w3js/w3js_references.asp">W3.JS
					Reference</a>
			</div>
			<div class="w3-col l3 m6">
				<h3 class="w3-margin-top">Server Side</h3>
				<a class="w3-bar-item w3-button" href='/sql/sql_ref_keywords.asp'>SQL
					Reference</a> <a class="w3-bar-item w3-button"
					href='/php/php_ref_overview.asp'>PHP Reference</a> <a
					class="w3-bar-item w3-button" href='/python/python_reference.asp'>Python
					Reference</a> <a class="w3-bar-item w3-button"
				...
				<a class="w3-bar-item w3-button" href='/xml/dom_nodetype.asp'>XML
					DOM Reference</a> <a class="w3-bar-item w3-button"
		...
		<div class="w3-row-padding w3-bar-block">
			<div class="w3-col l3 m6">
				...
				<a class="w3-bar-item w3-button" href='/html/html_examples.asp'>HTML
					...
					class="w3-bar-item w3-button" href='/howto/default.asp'>How To
					Examples</a> <a class="w3-bar-item w3-button"
				...
				<div class="w3-hide-large w3-hide-small">
					...
					<a class="w3-bar-item w3-button"
						...
						href="/quiztest/quiztest.asp?Qtest=CSS" target="_top">CSS Quiz</a>
					<a class="w3-bar-item w3-button"
						...
						Quiz</a> <a class="w3-bar-item w3-button"
						href="/quiztest/quiztest.asp?Qtest=PHP" target="_top">PHP Quiz</a>
					<a class="w3-bar-item w3-button"
						href="/quiztest/quiztest.asp?Qtest=SQL" target="_top">SQL Quiz</a>
					<a class="w3-bar-item w3-button"
						href="/quiztest/quiztest.asp?Qtest=XML" target="_top">XML Quiz</a>
				</div>
			</div>
			<div class="w3-col l3 m6">
				<h3 class="w3-margin-top">JavaScript</h3>
				<a class="w3-bar-item w3-button" href="/js/js_examples.asp"
					...
					class="w3-bar-item w3-button" href='/js/js_exercises.asp'>JavaScript
					Exercises</a> <a class="w3-bar-item w3-button"
					href="/js/js_dom_examples.asp" target="_top">HTML DOM Examples</a>
				<a class="w3-bar-item w3-button" href="/jquery/jquery_examples.asp"
					target="_top">jQuery Examples</a> <a class="w3-bar-item w3-button"
			...
			<div class="w3-col l3 m6">
				<h3 class="w3-margin-top">Server Side</h3>
				<a class="w3-bar-item w3-button" href='/sql/sql_exercises.asp'
					target="_top">SQL Exercises</a> <a class="w3-bar-item w3-button"
					href="/php/php_examples.asp" target="_top">PHP Examples</a> <a
					class="w3-bar-item w3-button" href='/python/python_exercises.asp'
					target="_top">Python Exercises</a> <a class="w3-bar-item w3-button"
					href="/asp/asp_examples.asp" target="_top">ASP Examples</a>
				<h3 class="w3-margin-top">XML</h3>
				<a class="w3-bar-item w3-button" href="/xml/xml_examples.asp"
					...
					Examples</a> <a class="w3-bar-item w3-button"
					href="/xml/ajax_examples.asp" target="_top">AJAX Examples</a> <a
					class="w3-bar-item w3-button" href="/graphics/svg_examples.asp"
					target="_top">SVG Examples</a>
			</div>
			<div class="w3-col l3 m6 w3-hide-medium">
				<h3 class="w3-margin-top">Quizzes</h3>
				<a class="w3-bar-item w3-button"
	...
	<nav id="nav_exercises"
		class="w3-light-grey w3-card-2 w3-hide-small w3-hide-medium navex">
		...
		<div class="w3-row-padding w3-bar-block">
			...
			<div class="w3-col l3 m12">
				<h3 class="w3-margin-top">JavaScript</h3>
				<a class="w3-bar-item w3-button" href="/js/js_exercises.asp">JavaScript
					Exercises</a> <a class="w3-bar-item w3-button"
					href="/jquery/jquery_exercises.asp">jQuery Exercises</a>
			</div>
			<div class="w3-col l3 m12">
				<h3 class="w3-margin-top">Server Side</h3>
				<a class="w3-bar-item w3-button" href="/sql/sql_exercises.asp">SQL
					Exercises</a> <a class="w3-bar-item w3-button"
					href="/php/php_exercises.asp">PHP Exercises</a> <a
					class="w3-bar-item w3-button" href="/python/python_exercises.asp">Python
					Exercises</a>
			</div>
			<div class="w3-col l3 m12">
				<h3 class="w3-margin-top">Quizzes</h3>
	...
	<div class="w3-main">
		...
		<div class="w3-row w3-margin-bottom">
			<div class="w3-col l6 w3-center" style="padding: 3%">
				<h1>HTML</h1>
				<p class="w3-xlarge w3-text-dark-grey">The language for building
					web pages</p>
				<a href="/html/default.asp" class="w3-button w3-dark-grey">LEARN
					HTML</a> <a href="/tags/default.asp" class="w3-button w3-dark-grey">HTML
					REFERENCE</a>
			</div>
			<div class="w3-col l6" style="padding: 3%">
				<div class="w3-hide-small w3-light-grey w3-card-2"
					...
					<div class="w3-code htmlHigh notranslate w3-border-green">
						...
						&lt;title&gt;HTML Tutorial&lt;/title&gt;<br> &lt;body&gt;<br>
						<br> &lt;h1&gt;This is a heading&lt;/h1&gt;<br>
						&lt;p&gt;This is a paragraph.&lt;/p&gt;<br> <br>
						&lt;/body&gt;<br> &lt;/html&gt;
					</div>
					<a href="/html/tryit.asp?filename=tryhtml_default" target="_blank"
						class="w3-button w3-theme w3-hover-green w3-hover-shadow">Try
						it Yourself &raquo;</a>
				</div>
			</div>
		</div>
		...
		<div class="w3-row w3-light-grey w3-hide-medium w3-hide-small">
			<div class="w3-col l6" style="padding-top: 40px; padding: 3%;">
				...
				<div class="w3-code cssHigh notranslate w3-card-2 w3-border-green">
					body {<br> &nbsp; background-color: lightblue;<br>}<br>
					<br> h1 {<br> &nbsp; color: white;<br> &nbsp;
					text-align: center;<br>}<br> <br> p {<br>
			...
			<div class="w3-col l6 w3-center" style="padding: 3%">
				...
				<a href="/css/default.asp" class="w3-button w3-dark-grey">LEARN
					CSS</a> <a href="/cssref/default.asp" class="w3-button w3-dark-grey">CSS
					REFERENCE</a>
			</div>
		</div>

		<div class="w3-row w3-light-grey w3-hide-large"
			...
			<div class="w3-col l6 w3-hide-small"
				style="padding-top: 40px; padding: 3%;">
				<h3>CSS Example:</h3>
				<div class="w3-code cssHigh notranslate w3-card-2 w3-border-green">
					body {<br> &nbsp; background-color: lightblue;<br>}<br>
					<br> h1 {<br> &nbsp; color: white;<br> &nbsp;
		...
		<div class="w3-row">
			<div class="w3-col l6 w3-center" style="padding: 3%">
				...
				<p class="w3-xlarge w3-text-dark-grey">The language for
					programming web pages</p>
				<a href="/js/default.asp" class="w3-button w3-dark-grey">LEARN
					JAVASCRIPT</a> <a href="/jsref/default.asp"
					class="w3-button w3-dark-grey">JAVASCRIPT REFERENCE</a>
			</div>
			<div class="w3-col l6" style="padding: 3%">
				<div class="w3-hide-small w3-card-2 w3-light-grey"
					style="padding: 16px;">
					<h3>JavaScript Example:</h3>
					<div class="w3-code notranslate w3-card-2 w3-border-green">
						<div class="htmlHigh">
							&lt;button onclick=&quot;myFunction()&quot;&gt;Click
							Me!&lt;/button&gt;<br> <br> &lt;script&gt;<br>
							function myFunction() {<br> &nbsp; var x =
		...
		<div class="w3-row w3-light-grey w3-padding-16">
			<div class="w3-col l6 w3-center" style="padding: 2% 3%;">
				<div class="w3-card-2 w3-white w3-padding"
					style="padding-bottom: 24px !important">
					<h2 class="w3-xxlarge">SQL</h2>
					<h4 class="w3-text-dark-grey">A language for accessing
						databases</h4>
					<a href="/sql/default.asp" class="w3-button w3-dark-grey">LEARN
						SQL</a>
				</div>
			</div>
			<div class="w3-col l6 w3-center" style="padding: 2% 3%;">
				<div class="w3-card-2 w3-white w3-padding"
					...
					<h4 class="w3-text-dark-grey">A web server programming
						language</h4>
					<a href="/php/default.asp" class="w3-button w3-dark-grey">LEARN
						PHP</a>
				</div>
			</div>
			<div class="w3-col l6 w3-center" style="padding: 2% 3%;">
				<div class="w3-card-2 w3-white w3-padding"
					...
					<h4 class="w3-text-dark-grey">A JavaScript library for
						developing web pages</h4>
					<a href="/jquery/default.asp" class="w3-button w3-dark-grey">LEARN
						JQUERY</a>
				</div>
			</div>
			<div class="w3-col l6 w3-center" style="padding: 2% 3%;">
				<div class="w3-card-2 w3-white w3-padding"
					...
					<h4 class="w3-text-dark-grey">A web server programming
						language</h4>
					<a href="/python/default.asp" class="w3-button w3-dark-grey">LEARN
						PYTHON</a>
				</div>
			</div>
		</div>
		<div class="w3-row">
			<div class="w3-col l4 w3-center" style="padding: 3%;">
				...
				<h4 class="w3-text-dark-grey">A modern CSS framework for faster
					and better responsive web pages</h4>
				<a href="/w3css/default.asp" class="w3-button w3-dark-grey">LEARN
					W3.CSS</a>
			</div>
			<div class="w3-col l4 w3-center" style="padding: 3%;">
				<h2 class="w3-xxlarge">Color Picker</h2>
				<a href="/colors/colors_picker.asp" class="w3-hover-opacity"><img
					style="width: 150px; height: 128px; margin-top: 16px;"
					src="/images/colorpicker.png" alt="Colorpicker"></a>
			</div>
			<div class="w3-col l4 w3-center" style="padding: 3%;">
				<h2 class="w3-xxlarge">Bootstrap</h2>
				<h4 class="w3-text-dark-grey">A CSS framework for designing
					better web pages</h4>
				<a href="/bootstrap/default.asp" class="w3-button w3-dark-grey">LEARN
					BOOTSTRAP</a>
			</div>
		</div>
		<br>

		<div class="w3-dark-grey w3-center w3-padding-large w3-padding-48"
			style="padding-bottom: 68px !important">
			<h2 class="w3-xxlarge">Exercises</h2>
			<h4>Test yourself with exercises</h4>
			<div class="w3-row-padding w3-content">
				<div class="w3-third">
					<p>
						<a class="w3-btn w3-green w3-block w3-padding-16"
							href="/html/html_exercises.asp">HTML Exercises</a>
					</p>
				</div>
				<div class="w3-third">
					<p>
						<a class="w3-btn w3-green w3-block w3-padding-16"
							href="/css/css_exercises.asp">CSS Exercises</a>
					</p>
				</div>
				<div class="w3-third w3-hide-large w3-hide-small">
					<p>
						<a class="w3-btn w3-green w3-block w3-padding-16"
							href="/js/js_exercises.asp">JS Exercises</a>
					</p>
				</div>
				<div class="w3-third w3-hide-medium">
					<p>
						<a class="w3-btn w3-green w3-block w3-padding-16"
							href="/js/js_exercises.asp">JavaScript Exercises</a>
					</p>
				</div>
			</div>
			<div class="w3-row-padding w3-content w3-hide-small">
				<div class="w3-quarter">
					<p>
						<a class="w3-btn w3-green w3-block w3-padding-16"
							href="/sql/sql_exercises.asp">SQL</a>
					</p>
				</div>
				<div class="w3-quarter">
					<p>
						<a class="w3-btn w3-green w3-block w3-padding-16"
							href="/php/php_exercises.asp">PHP</a>
					</p>
				</div>
				<div class="w3-quarter">
					<p>
						<a class="w3-btn w3-green w3-block w3-padding-16"
							href="/python/python_exercises.asp">Python</a>
					</p>
				</div>
				<div class="w3-quarter">
					<p>
						<a class="w3-btn w3-green w3-block w3-padding-16"
							href="/jquery/jquery_exercises.asp">jQuery</a>
					</p>
				</div>
			</div>
		</div>
		...
		<div class="w3-light-grey w3-center w3-padding-large w3-padding-32">
			...
			<h4 class="w3-text-dark-grey">
				Browse our selection of <strong>free</strong> responsive HTML
				Templates
			</h4>
			<div class="w3-content">
				<a href="/w3css/w3css_templates.asp"><img
					src="w3css_templates.jpg"
					style="width: 100%; margin: 16px 0 20px 0" alt="W3.CSS Templates"></a>
			</div>
			<p>
				<a href="/w3css/w3css_templates.asp"
					class="w3-button w3-dark-grey w3-padding-large w3-mobile">BROWSE
					TEMPLATES</a>
			</p>
		</div>
		<br>

		<div class="w3-white w3-center w3-padding-large w3-padding-16"
			style="padding-bottom: 36px !important">
			<h2 class="w3-xxlarge">How To Section</h2>
			<h4 class="w3-text-dark-grey">Code snippets for HTML, CSS and
				JavaScript</h4>
			<div class="w3-content w3-hide-device">
				<div class="w3-row-padding" style="margin: 32px -16px">
					<div class="w3-col l6 s12">
						<iframe src="/howto/tryhow_css_sidenav_ifr.htm"
							style="width: 100%; border: 5px solid #ddd; height: 300px"></iframe>
					</div>
					<div class="w3-col l6 w3-hide-small w3-hide-medium">
						<iframe src="/howto/tryhow_css_sidenav_ifr2.htm"
							style="width: 100%; border: 5px solid #ddd; height: 300px"></iframe>
					</div>
				</div>
			</div>
			<p>
				<a href="/howto/default.asp"
					class="w3-button w3-dark-grey w3-padding-large w3-mobile">LEARN
					HOW TO</a>
			</p>
		</div>

		<div class="w3-display-container w3-black" id="certsection">
			<a href="/cert/default.asp"> <img src="getcertified.jpg"
			...
			<p class="w3-display-middle getcert">
				<a href="/cert/default.asp"
					class="w3-button w3-green w3-hover-white w3-padding-large"
					style="font-size: 17px">Get Certified &raquo;</a>
			</p>
		</div>
		...
		<footer class="w3-container w3-dark-grey w3-center w3-padding-32">
			<div class="w3-container w3-padding-32">
				<a
					class="w3-button w3-light-grey w3-hide-small w3-hide-medium w3-left"
					href="/cert/default.asp" style="font-size: 16px; margin-top: -9px">WEB
					CERTIFICATES</a> <a
					class="w3-button w3-light-grey w3-hide-small w3-hide-medium w3-left"
					href="/quiztest/quiztest.asp?Qtest=HTML"
					style="font-size: 16px; margin-top: -9px; margin-left: 12px">QUIZZES</a>
				<a
					class="w3-button w3-light-grey w3-hide-small w3-hide-medium w3-left"
					target="_blank"
					href="/html/exercise.asp?filename=exercise_attributes1"
					style="font-size: 16px; margin-top: -9px; margin-left: 12px">EXERCISES</a>
				<a class="w3-button w3-light-grey w3-hide-large"
					href="/cert/default.asp"
					style="font-size: 16px; margin-bottom: 16px">CERTIFICATES</a> <a
					class="w3-button w3-light-grey w3-hide-large"
					href="/quiztest/quiztest.asp?Qtest=HTML"
					style="font-size: 16px; margin-bottom: 16px;">QUIZZES</a> <a
					class="w3-button w3-light-grey w3-hide-large" target="_blank"
					href="/html/exercise.asp?filename=exercise_attributes1"
					style="font-size: 16px; margin-bottom: 16px;">EXERCISES</a>
				<nav class="w3-right w3-hide-medium w3-hide-small w3-wide">
					<a href="/forum/default.asp" target="_blank"
						class="w3-hover-text-green" style="text-decoration: none">FORUM</a>
					| <a href="/about/default.asp" target="_top"
						class="w3-hover-text-green" style="text-decoration: none">ABOUT</a>
				</nav>
			...
			<p class="w3-medium">
				...
				using this site, you agree to have read and accepted our <a
					href="/about/about_copyright.asp" class="w3-hover-text-green">terms
					of use</a>, <a href="/about/about_privacy.asp"
					class="w3-hover-text-green">cookie and privacy policy</a>.<br>
				<a href="/about/about_copyright.asp" class="w3-hover-text-green">Copyright
					1999-2019</a> by Refsnes Data. All Rights Reserved.<br> <br>
			</p>
			<a href="javascript:void(0);" onclick="clickFBLike()"
				title="Like W3Schools on Facebook" class="w3-hover-text-light-grey">
				<i class="fa fa-thumbs-o-up w3-xxlarge"></i>
			</a>
	...
	<script>
		...
		function open_xs_menu(x) {
			if (document.getElementById("sectionxs_" + x).innerHTML == "") {
				document.getElementById("sectionxs_" + x).innerHTML = document
						.getElementById("nav_" + x).innerHTML;
			} else {
		...
		function clickFBLike() {
			...
			document.getElementById("popupDIV").innerHTML = "<iframe src='/fblike.asp?r="
					+ Math.random()
					+ "' frameborder='no' style='height:200px;width:250px;'></iframe><br><button onclick='hideFBLike()' class='w3-button w3-dark-grey w3-hover-black'>Close</button>";
		}
		function hideFBLike() {
